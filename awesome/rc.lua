...
beautiful.bg_normal = "#1C1E26"
beautiful.bg_systray = beautiful.bg_normal
beautiful.bg_very_light = "#2E303E"
beautiful.fg_normal = "#6e7476"
beautiful.fg_dark = "#ffffff"
...
local function set_wallpaper(s)
    gears.wallpaper.maximized("/home/tet/Downloads/wallpaper.png", s, true)
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn("rofi -show run") end,
              {description = "open rofu", group = "launcher"}),
    -- Brightness
    awful.key({ }, "XF86MonBrightnessDown", function () 
            awful.spawn.easy_async_with_shell("xbacklight -15", function(stdout)
		    awesome.emit_signal("popup::brightness", {amount = -15})
	    end)
    end),
    ...
    awful.key({ modkey, "Shift" }, "p",     function () 
        awful.spawn.easy_async_with_shell("scrot -s -e 'echo $f'", function(stdout)
            local fileName = string.gsub(stdout, "\n", "")
            notifications.screenshot(fileName)
        end)
    end),
    -- Sound
     -- media controls
